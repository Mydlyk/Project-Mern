...
const Employee = () => {
    ...
    const GetEmployeeData = () => {
        ...
        const url2 = 'http://localhost:8000/education'
        axios.get(url)
            .then(response => {
    ...
    const handleEdit = () =>{
        ...
        const url2 = `http://localhost:8000/education/${id}`
        const Credentials2 ={education}
        const Credentials = { name, email, number, nic, address }
        axios.put(url2, Credentials2)
            .then(response => {
                const result = response.data;
                ...
                >
                    ...
                    <Modal.Body>
                        <div>
                            ...
                            <div className='form-group mt-3'>
                                <input type="text" className='form-control' value={RowData.education} readOnly />
                            </div>
                            {
                                Delete && (
                ...
                >
                    ...
                    <Modal.Body>
                        <div>
                            ...
                            <div className='form-group mt-3'>
                                <input type="text" className='form-control' onChange={(e) => seteducation(e.target.value)} placeholder="Please enter Education" />
                            </div>
                    ...
                    <Modal.Body>
                        <div>
                            ...
                            <div className='form-group mt-3'>
                                ...
                                <input type="text" className='form-control' onChange={(e) => seteducation(e.target.value)} placeholder="Please enter Education" defaultValue={RowData.education}/>
                            </div>
